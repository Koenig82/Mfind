...
Syfte: Installera en minneshanterare för listan så att den kan ta över
       ansvaret för att avallokera minnet får värdena då de ej finns kvar
       i listan mer.
Parametrar: l - listan
...
Kommentarer: Bara minne får värden som finns i listan vid tidpunkten då en
...
Returvärde: Positionen får det nyinstoppade värdet
Kommentarer:
*/
...
Kommentarer: Om en funktion för att avallokera minnet för datavärdena
             ...
             annars är detta anv�ndarens ansvar.
